...
# --- Configuration ---
PRETRAINED_MODEL_NAME = "yolo26n.pt" # changed to any model you like
DATA_YAML = "parking_spot_dataset/data.yaml"
ULTRALYTICS_OUTPUT_DIR = "yolo_parking_spot_gridsearch_outputs_26"
IMAGE_SIZE = 640

# --- MLflow Setup ---
mlflow.set_tracking_uri("http://127.0.0.1:5000")
EXPERIMENT_NAME = "yolo_parking_spot_gridsearch_outputs_26"
...
for i, params in enumerate(hyperparameter_combinations):
    run_name_parts = [f"grid_run_yolo_26n_{i+1}"]
